...
#else
static char _TranslateRadialDragger_h[] = "University of Edinburgh $Id$";
#endif
/*!
...
*  		Resource names and part names for this dragger are:
		...
		<tr>
		  <td>translateRadialTranslator</td>
		  <td>translator</td>
		</tr>
		<tr>
		  <td>translateRadialTranslatorActive</td>
		  <td>translatorActive</td>
		</tr>
		<tr>
		  <td>translateRadialFeedback</td>
		  <td>feedback</td>
		</tr>
		<tr>
		  <td>translateRadialFeedbackActive</td>
...
class TranslateRadialDragger : public LandmarkDragger
{
  ...
  protected:
    SbLineProjector *lineProj;        	/*!< Line projector for calculating
  					     motion along a line */
