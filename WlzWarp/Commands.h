...
#else
static char _Commands_h[] = "University of Edinburgh $Id$";
#endif
/*!
* \file         Commands.h
* \author       Zsolt Husz
 ...
 * \ingroup	UI
 */
class CreateWoolzObject:
public QUndoCommand
{
  public:
    CreateWoolzObject(ObjectListModel *objectListModel, WoolzObject *object,
  ...
  private:
    ...
    bool m_allive;                 		/*!< if the object is alive,
						     otherwise if ready to be
						     deleted */
};
...
{
  public:
    DeleteWoolzObject(ObjectListModel *objectListModel,
        WoolzObject *object, QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
...
{
  public:
    CreateMeshObject(ObjectListModel *objectListModel,
	LandmarkModel *landmarkModel, WoolzObject *object,
	QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
  ...
  private:
    ...
    WoolzObject *m_object;                      /*!< new WoolzObject mesh
						     object */
    WoolzObject *m_oldObject;                   /*!< previous WoolzObject
						     mesg object */
    bool m_allive;                 		/*!< if the object is allive,
						     otherwise if ready to be
						     deleted */
};
...
{
  public:
    RenameObject(WoolzObject *object, QString name,
	QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
  ...
  private:
    WoolzObject *m_object;          		/*!< WoolzObject to be
						     changed */
...
{
  public:
    ColourObject(WoolzObject *object, const QColor colour,
	QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const ;
...
{
  public:
    WoolzObjectChangeVisibility(WoolzObject *object, const bool visible,
        QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id () const ;
...
{
  public:
    RemoveLandmark(LandmarkModel *model, int index,
        QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
  private:
    LandmarkModel *m_model;			/*!< landmark model */
    PointPair m_pp;                             /*!< the removed point pair
    						     values */
...
{
  public:
    AddLandmark(LandmarkModel *model, PointPair &pp,
    		QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
  private:
...
/*!
 * \brief	Undoable command to add half landmark in for the source
 * 		or the target
 * \ingroup	UI
 */
...
{
  public:
    AddHalfLandmark(LandmarkController *controller,
        const WlzDVertex3 newPosition, LandmarkModel::IndexType indexType,
	QUndoCommand * parent = 0);
    AddHalfLandmark(LandmarkController *controller,
        const SbVec3f newPosition, LandmarkModel::IndexType indexType,
	QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
  private:
    ...
    LandmarkModel::IndexType m_indexType;       /*!< the type of the half
    						     landmark*/
    bool     m_previouslySet;                   /*!< if true, the landmark has to be moved, not added*/
};

/*!
 * \brief	Undoable command to pair half landmark in for the source
 * 		or the target. This will result a new landmark pair being
...
{
 public:
     AddSecondHalfLandmark(LandmarkController *controller,
         const WlzDVertex3 newPosition, LandmarkModel::IndexType indexType,
	 QUndoCommand * parent = 0);
     virtual void undo();
     virtual void redo();
...
{
 public:
     MoveLandmark(LandmarkModel *model, int index, const SbVec3f newPosition,
         LandmarkModel::IndexType indexType, QUndoCommand * parent = 0);
     virtual void undo();
     virtual void redo();
     bool mergeWith(const QUndoCommand * command);
     int id () const;
...
{
  public:
    LoadLandmarks(LandmarkModel *model, QString filename,
        QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
  private:
...
/*!
 * \brief	Undoable command to enable or disable global update for
 * 		a group of undo commands.
 *              Must be used in pairs at the begining and at the end of
 *              group of commands
 * \ingroup	UI
 */
...
{
  public:
    EnableDisableUpdateCommand(bool isFirst, EnableDisableUpdateCommand * pair,
        QUndoCommand * parent = 0);
    EnableDisableUpdateCommand(QUndoCommand * parent = 0);
    void setPair(bool isFirst,
        EnableDisableUpdateCommand * pair);  // must not be virtual (called
				             // from constructor)
    virtual void undo();
    virtual void redo();
    virtual bool state() {return m_state;};
  private:
    bool m_isFirst;                         	/*!< true if this is the first
    			                             command in the group and
						     false if is the last  */
    EnableDisableUpdateCommand * m_pair;        /*!< the pair command */
    bool m_state;                               /*!< the auto update value
                                                     before the command groups
						     started */
};
...
{
  public:
    SetLowThreshold(WoolzDynThresholdedObj *object, unsigned char lowTh,
        QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
    bool mergeWith(const QUndoCommand * command);
  private:
    WoolzDynThresholdedObj *m_object;		/*!< WoolzObject to be
    						     changed */
...
{
  public:
    SetHighThreshold(WoolzDynThresholdedObj *object,
        const unsigned char highTh, QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const ;
    bool mergeWith(const QUndoCommand * command);
...
/*!
 * \brief	Undoable command to set WoolzDynThresholdedObj thresholding
 * 		channel
 * \ingroup	UI
 */
...
{
  public:
    WoolzDynThresholdedObjSetChannel(WoolzDynThresholdedObj *object,
...
{
  public:
    WoolzDynObjectSetAutoUpdate(WoolzDynObject *object, const bool enabled,
        QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
    bool mergeWith(const QUndoCommand * command);
  private:
    WoolzDynObject *m_object;			/*!< WoolzObject to be
    						     changed */
...
/*!
 * \brief	Undoable command to set WoolzDynObjectSetAutoUpdate source
 * 		object
 * \ingroup	UI
 */
...
{
  public:
    WoolzDynObjectSetSourceObj(WoolzDynObject *object, WoolzObject *sourceObj,
	QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
...
{
  public:
    WoolzDynISOObjSetValue(WoolzDynContourISO *object, char value,
	QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
    bool mergeWith(const QUndoCommand * command);
  private:
    WoolzDynContourISO *m_object; 		/*!< WoolzObject to be
						     changed */
...
{
  public:
    WoolzDynISOObjSetBoundary(WoolzDynContourISO *object, bool enabled,
        QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
...
/*!
 * \brief	Undoable command to set WoolzDynISOObjSetValue subsampling
 * 		rate
 * \ingroup	UI
 */
...
{
  public:
    WoolzDynISOObjSetSubsample(WoolzDynContourISO *object, char subsample,
	QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
...
/*!
 * \brief	Undoable command to set WoolzDynISOObjSetValue filtering
 * 		on or off
 * \ingroup	UI
 */
...
{
  public:
    WoolzDynISOObjSetFilter(WoolzDynContourISO *object, bool enabled,
        QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
...
{
  public:
    WoolzDynISOObjSetShellSelection(WoolzDynContourISO *object,
        int selection, QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
    bool mergeWith(const QUndoCommand * command);
...
{
  public:
    TransferFunctionMapUpdate(ObjectListModel *objectListModel, int objID,
        SoMFFloat &colorMap, QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
    bool mergeWith(const QUndoCommand * command);
...
/*!
 * \brief	Undoable command to set transfer function high cut off
 * 		treshold.
 * \ingroup	UI
 */
...
{
  public:
    WarpingSetDelta(LandmarkModel *landmarkModel, double delta,
        QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
    bool mergeWith(const QUndoCommand * command);
  private:
    LandmarkModel *m_landmarkModel;		/*!< LandmarkModel managing
    						     delta */
...
{
  public:
    WarpingSetSnapToFitDist(LandmarkModel *landmarkModel, double stfd,
       QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
...
{
  public:
    WarpingtSetBasisFnType(LandmarkModel *landmarkModel,
	LandmarkModel::BasisFnType basisFnType, QUndoCommand * parent = 0);
    virtual void undo();
    virtual void redo();
    int id() const;
    bool mergeWith(const QUndoCommand * command);
