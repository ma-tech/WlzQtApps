...
#else
static char _ViewerDelegate_h[] = "University of Edinburgh $Id$";
#endif
/*!
...
class ViewerDelegate : public QStyledItemDelegate
{
  ...
  public:
    ...
    /*!
     * \ingroup	UI
     * \brief	Renders the delegate using the given painter and style
     * 		option for the item specified by index.
     */
     ...
     * \param	option			style option are used to control how
