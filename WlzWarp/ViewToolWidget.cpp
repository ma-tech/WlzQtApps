...
#else
static char _ViewToolWidget_cpp[] = "MRC HGU $Id$";
#endif
#endif
/*!
...
ViewToolWidget::ViewToolWidget(ObjectViewerModel *objectViewerModel, MainWindow *parent):
 QDockWidget(parent) {
...
ViewToolWidget::~ViewToolWidget() {
}

void ViewToolWidget::EditView() {
}

void ViewToolWidget::currentChanged ( const QModelIndex & current,
