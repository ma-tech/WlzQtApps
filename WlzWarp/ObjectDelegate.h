...
#else
static char _ObjectDelegates_h[] = "MRC HGU $Id$";
#endif
#endif
/*!
...
/*!
* \brief	Provides display and editing facilities in object tool tree view
* \ingroup      UI
*/
...
public:
  ...
  * \ingroup      UI
  * \brief        Constructor
  * \param        view view that holds this widget needed to make the color editor widget persistent (editable all the time)
...
private slots:
  ...
  */
  void emitCommitData();
private:
   QAbstractItemView *m_view;      /*!< view contating the element managed by the delegate visualising,
                                        required to set persistent state */
};
