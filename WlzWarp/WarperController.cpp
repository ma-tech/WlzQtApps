...
#else
static char _WarperController_cpp[] = "University of Edinburgh $Id$";
#endif
/*!
...
m_projectProperties(projectProperties)
{
  ...
  connect(objectListModel, SIGNAL(replaceWarpMesh(WoolzObject *)),
          m_woolzTransform , SLOT(setMeshObject(WoolzObject *)));


  Q_ASSERT(objectListModel);
  connect(&config, SIGNAL(updateAll()),
          objectListModel , SLOT(updateAll()));
  connect(&config, SIGNAL(updateAllWarped()),
          objectListModel , SLOT(updateAllWarped()));

  connect(objectListModel , SIGNAL(statusChanged(QString, int)),
          mainWindow, SLOT(statusChanged(QString, int)));

  //create landmark manager
  landmarkController = new LandmarkController(undoStack, landmarkModel);

  m_objectViewerController =
      new ObjectViewerController(mainWindow, landmarkController);
  ...
  {
    viewToolWidget =
        new ViewToolWidget(m_objectViewerController->model(), mainWindow);
  ...
  {
    transformWidget =
        new TransformWidget(mainWindow, objectListModel, m_woolzTransform);
  ...
  if(!transferFunctionWidget)
  {
    transferFunctionWidget =
        new TransferFunctionWidget(mainWindow, objectListModel);
  ...
  if(!sectioningPlaneWidget)
  {
    sectioningPlaneWidget =
        new SectioningPlaneWidget(mainWindow, m_objectViewerController);
  ...
  connect(objectListModel, SIGNAL(addObjectSignal(WoolzObject*)),
          m_objectViewerController, SIGNAL(addObjectSignal(WoolzObject*)));
  connect(objectListModel, SIGNAL(removedObjectSignal(WoolzObject*)),
          m_objectViewerController, SIGNAL(removedObjectSignal(WoolzObject*)));
  connect(objectListModel, SIGNAL(updatePossibleChange(bool)),
          this, SLOT(updatePossibleChanged(bool)));

  connect(mainWindow->actionAllEditing, SIGNAL(triggered()),
          m_objectViewerController, SIGNAL(setEditingMode()));
  connect(mainWindow->actionAllViewing, SIGNAL(triggered()),
          m_objectViewerController, SIGNAL(setViewingMode()));
  connect(mainWindow->actionSwitchModes, SIGNAL(triggered()),
          m_objectViewerController, SIGNAL(switchModes()));

  connect(m_objectViewerController,
	  SIGNAL(signalRequestAllObjects(ObjectViewer *)),
	  objectListModel,
	  SLOT(addAllObjects(ObjectViewer *)));

  connect(mainWindow->actionShowLandmarks, SIGNAL(toggled(bool)),
          this, SLOT(landmarkVisibilityToggled(bool)));
  connect(mainWindow->actionAutoWarp, SIGNAL(toggled(bool)),
          this, SLOT(globalAutoUpdate(bool)));
  connect(mainWindow->actionShowMesh, SIGNAL(toggled(bool)),
          this, SLOT(warpingMeshUpdate(bool)));
...
{
  {
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/undo.png")),
  ...
  }
  {
    ...
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/redo.png")),
	QIcon::Normal, QIcon::Off);
  ...
  if(objectToolWidget)
  {
    ...
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/objects.png")),
	QIcon::Normal, QIcon::Off);
    toggleAction->setIcon(icon);
    mainWindow->toolBarOperations->addAction(toggleAction);
    mainWindow->menuView->insertAction(mainWindow->menuToolbars->menuAction(),
	                               toggleAction);
  }
  if(viewToolWidget)
  {
    ...
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/views.png")),
	QIcon::Normal, QIcon::Off);
    toggleAction->setIcon(icon);
    mainWindow->toolBarOperations->addAction(toggleAction);
    mainWindow->menuView->insertAction(mainWindow->menuToolbars->menuAction(),
  ...
  mainWindow->menuView->insertSeparator(
      mainWindow->menuToolbars->menuAction());
  ...
  if(objectPropertyWidget)
  {
    ...
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/properties.png")),
	QIcon::Normal, QIcon::Off);
    toggleAction->setIcon(icon);
    mainWindow->toolBarOperations->addAction(toggleAction);
  ...
  if(segmentWidget)
  {
    ...
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/segmentation.png")),
	QIcon::Normal, QIcon::Off);
    toggleAction->setIcon(icon);
    mainWindow->toolBarOperations->addAction(toggleAction);
    mainWindow->menuActions->addAction(toggleAction);
  ...
  if(transformWidget)
  {
    ...
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/transformation.png")),
	QIcon::Normal, QIcon::Off);
    toggleAction->setIcon(icon);
    mainWindow->toolBarOperations->addAction(toggleAction);
    mainWindow->menuActions->addAction(toggleAction);
  ...
  if(warpingWidget)
  {
    ...
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/warpingparams.png")),
	QIcon::Normal, QIcon::Off);
    toggleAction->setIcon(icon);
    mainWindow->toolBarOperations->addAction(toggleAction);
    mainWindow->menuActions->addAction(toggleAction);
  ...
  if(contourWidget)
  {
    ...
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/contour.png")),
	QIcon::Normal, QIcon::Off);
    toggleAction->setIcon(icon);
  ...
  if(transferFunctionWidget && projectInitialised && project3D)
  {
    ...
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/transferfunction.png")),
	QIcon::Normal, QIcon::Off);
    toggleAction->setIcon(icon);
    mainWindow->toolBarOperations->addAction(toggleAction);
    mainWindow->menuActions->addAction(toggleAction);
  ...
  if(sectioningPlaneWidget && projectInitialised && project3D)
  {
    ...
    QIcon icon;
    icon.addPixmap(
	QPixmap(QString::fromUtf8(":/icons/images/cuttingplaneon.png")),
	QIcon::Normal, QIcon::Off);
    toggleAction->setIcon(icon);
    mainWindow->toolBarOperations->addAction(toggleAction);
    mainWindow->menuActions->addAction(toggleAction);
...
bool WarperController::
openValueTarget()
{
  QString filename = QFileDialog::getOpenFileName(mainWindow,
      tr("Open target value object"), getLastPath(),
...
openValueSource()
{
  ...
  if((newVolumeObject = loadValue(filename, WoolzObject::source)))
  {
    ...
    else
    {
      ...
      {
        WoolzDynWarpedObject * warpedObject =
	    new WoolzDynWarpedObject(objectListModel, m_woolzTransform);
...
{
  QString filename = QFileDialog::getOpenFileName(mainWindow,
      tr("Open Woolz Mesh"), getLastPath(),
      tr("Woolz object (*.wlz)"));
  if(filename.isEmpty())
  {
    return(false);
  ...
  if((newMeshObject = loadMesh(filename, WoolzObject::target)))
  {
    ...
    else
    {
      ...
      m_objectViewerController->addTargetViewer();
      undoStack->push(new CreateMeshObject(
	    objectListModel, landmarkModel, newMeshObject));
      setLastPath(filename);
      QApplication::restoreOverrideCursor();
      ok = true;
    }
...
{
  QString filename = QFileDialog::getOpenFileName(mainWindow,
      tr("Open Woolz Surface"), getLastPath(),
      tr("Woolz object (*.wlz)"));
  if(filename.isEmpty())
  {
    return(false);
...
void  WarperController::
connectSignals()
{
  setupToolbars();
  connect(mainWindow->actionSaveProjectAs, SIGNAL(triggered()),
          this, SLOT(saveProjectAs()));
  connect(mainWindow->actionSaveProject, SIGNAL(triggered()),
          this, SLOT(saveProject()));
  connect(mainWindow->actionOpenValueTarget, SIGNAL(triggered()),
          this, SLOT(openValueTarget()));
  connect(mainWindow->actionOpenMeshTarget, SIGNAL(triggered()),
          this, SLOT(openMeshTarget()));
  connect(mainWindow->actionOpenSurfaceTarget, SIGNAL(triggered()),
          this, SLOT(openSurfaceTarget()));
  connect(mainWindow->actionOpenCompositeTarget, SIGNAL(triggered()),
          this, SLOT(openCompositeTarget()));
  connect(mainWindow->actionOpenValueSource, SIGNAL(triggered()),
          this, SLOT(openValueSource()));
  connect(mainWindow->actionOpenMeshSource, SIGNAL(triggered()),
          this, SLOT(openMeshSource()));
  connect(mainWindow->actionOpenSurfaceSource, SIGNAL(triggered()),
          this, SLOT(openSurfaceSource()));
  connect(mainWindow->actionExportWarpedObject, SIGNAL(triggered()),
          this, SLOT(saveWarpedObject()));
  connect(mainWindow->actionExportWarpTransform, SIGNAL(triggered()),
          this, SLOT(saveWarpingTransform()));

  connect(mainWindow->actionSaveLandmarks, SIGNAL(triggered()),
          this, SLOT(saveAsLandmarks()));
  connect(mainWindow->actionLoadLandmarks, SIGNAL(triggered()),
          this, SLOT(loadLandmarks()));
  connect(mainWindow->actionGenerateMesh, SIGNAL(triggered()),
          this, SLOT(generateMesh()));
  connect(mainWindow->actionSourceView, SIGNAL(triggered()),
          this, SLOT(addSourceViewer()));
  connect(mainWindow->actionTargetView, SIGNAL(triggered()),
          this, SLOT(addTargetViewer()));
  connect(mainWindow->actionResultView, SIGNAL(triggered()),
          this, SLOT(addResultViewer()));
  connect(mainWindow->actionMinimize, SIGNAL(triggered()),
          this, SLOT(minimizeSubWindow()));
  connect(mainWindow->actionMaximize, SIGNAL(triggered()),
          this, SLOT(maximizeSubWindow()));
  connect(mainWindow->actionRestore, SIGNAL(triggered()),
          this, SLOT(restoreSubWindow()));
  connect(mainWindow->actionDefaultLayout, SIGNAL(triggered()),
          m_objectViewerController, SLOT(defaultLayout()));
  connect(mainWindow->actionDefaultViewLinks, SIGNAL(triggered()),
          m_objectViewerController, SLOT(defaultViewLinks()));
  connect(mainWindow->getWorkspace(),
  ...
  connect(mainWindow->getWorkspace(),
	  ...
	  sectioningPlaneWidget,
	  SLOT(viewerSelected()));
  connect(mainWindow->actionAddLandmark, SIGNAL(toggled(bool)),
          this, SLOT(addToggled(bool)));
  connect(mainWindow->actionDeleteLandmark, SIGNAL(toggled(bool)),
          this, SLOT(deleteToggled(bool)));
  connect(mainWindow->actionMoveLandmark, SIGNAL(toggled(bool)),
          this, SLOT(moveToggled(bool)));
  connect(mainWindow->actionRemoveMeshElement, SIGNAL(toggled(bool)),
          this, SLOT(removeElementToggled(bool)));
  connect(mainWindow->actionDeleteLandmark, SIGNAL(toggled(bool)),
          landmarkController, SLOT(deleteHighlightedLandmark()));
  connect(mainWindow->actionRemoveAllLandmarks, SIGNAL(triggered()),
          landmarkController, SLOT(removeAllLandmarks()));
  connect(objectListModel, SIGNAL(replaceWarpMesh(WoolzObject *)),
          this, SLOT(updateShowMesh(WoolzObject*)));
  connect(mainWindow->actionOptions, SIGNAL(triggered()),
          this, SLOT(options()));
  connect(mainWindow->actionProjectProperties, SIGNAL(triggered()),
          this, SLOT(setProjectProperties()));

  connect(mainWindow->actionUpdate, SIGNAL(triggered()),
          this, SLOT(updateNow()));
  mainWindow->actionShowMesh->setEnabled(
      objectListModel->getMeshObject() != NULL);
}

WoolzObject* WarperController::
loadMesh(
  QString filename,
  ...
  if(meshObject)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        meshObject->setRemovable(false); 	// cannot be removed from
						// object tool dialog
      }
    }
  }
  ...
  if(valueObject)
  {
    ...
    if(!valueObject->isValuePreRead())
    {
      ...
      QMessageBox::warning(NULL, "Value object open",
	                   "Woolz file has no value object.") ;
      delete valueObject;
      valueObject = NULL;
    }
    else
    {
      ...
      if(valueObject->is3D() && valueObject->isValueSet())
      {
        WlzGreyType greyType = valueObject->getWoolzGreyType();
        if(greyType != WLZ_GREY_UBYTE && greyType != WLZ_GREY_SHORT &&
	   greyType != WLZ_GREY_INT)
        {
          QMessageBox::warning(NULL, "Value object open",
	      "Only UBYTE, SHORT and INT objects are supported.") ;
          delete valueObject;
          return(NULL);
        }
      }
      ...
      {
        QMessageBox::warning(NULL, "Value object open", "File " +
	                     filename + "\n cannot be read.") ;
        delete valueObject;
        valueObject = NULL;
      }
      else
      {
        ...
        valueObject->setRemovable(true);	// cannot be removed from
					        // object tool dialog
      }
    }
  }
  ...
  WoolzObject::WoolzObjectType type)
{
  ...
  if(surfaceObject)
  {
    ...
    {
      QApplication::restoreOverrideCursor();
      QMessageBox::warning(NULL, "Contour open",
	                   "Woolz file has no contour object.");
    ...
    else
    {
      ...
      {
        QMessageBox::warning(NULL, "Surface open", "File " +
	                     filename + "\n is not a valid Woolz file.");
        delete surfaceObject;
        surfaceObject = NULL;
      }
      ...
      else
      {
        ...
        surfaceObject->setRemovable(true);	// cannot be removed from
						// object tool dialog
      }
    }
  }
...
bool WarperController::
is2D3Dcompatibile(WoolzObject *object)
{
  ...
  if(projectInitialised)
  {
    if(is3D != project3D)
    {
      // object is not the same dimensionality as the previous object loaded
      QMessageBox::warning(NULL, tr("Load mesh error"),
          tr("Object cannot be loaded into this project: it is %1 while "
	     "objects of the project are %2").
	  arg(is3D ? "3D" : "2D").arg(is3D ? "2D" : "3D"));
      return(false);
    }
  }
  else set3D(is3D);
...
void WarperController::
landmarkVisibilityToggled(
  bool checked)
{
  landmarkController->getLandmarkView(LandmarkModel::sourceV)->
      setVisibility(checked);
  landmarkController->getLandmarkView(LandmarkModel::targetV)->
      setVisibility(checked);
}
...
saveWarpedObject()
{
  ...
  {
    QMessageBox::warning(NULL, "Save warped object",
	                 "No available warped object.");
    return;
  }
  QString filename = QFileDialog::getSaveFileName(mainWindow,
      tr("Save warped object"), getLastPath(),
      tr("Woolz object (*.wlz)"));
  if(!filename.isEmpty())
  {
    ...
    {
      QMessageBox::warning(NULL, "Save warped object",
	                   "Cannot save object to file " + filename + ".") ;
    }
    else
    {
      setLastPath(filename);
...
void WarperController::
saveWarpingTransform()
{
  QString filename = QFileDialog::getSaveFileName(mainWindow,
      tr("Save warping transform"), getLastPath(),
  ...
  if(!filename.isEmpty())
  {
    ...
    {
      QMessageBox::warning(NULL, "Save warping transform",
	                   "Canot save transform to file.") ;
    }
    else
    {
      setLastPath(filename);
  ...
  QString filename)
{
  ...
  {
    mainWindow->statusChanged("Transform generation failed: " +
	                      errorMsg + ".", 0);
    return false;
  }
  ...
  if(errNum == WLZ_ERR_NONE)
  {
	...
	(errNum == WLZ_ERR_NONE)?
	"Saving transform succeded.": "Saving transform failed.", 0);
  }
...
saveAsLandmarks()
{
  ...
  {
    QMessageBox::warning(NULL, tr("Save warping"),
	                 tr("Cannot create warping file."));
    return;
  }
  if(type == txt)
  {
...
generateMesh()
{
  ...
  MeshDialog *dialog = new MeshDialog(mainWindow, objectListModel,
      useSource, project3D);
  ...
  WoolzObject* mesh)
{
  ...
  if(mesh)
  {
    connect(mesh, SIGNAL(objectVisibilityChanged()),
	    this, SLOT(warpingMeshUpdateAction()));
  }
}
...
options()
{
  ...
  connect(dialog, SIGNAL(configurationChanged()),
          m_objectViewerController->model(), SLOT(configurationChanged()));
  connect(dialog, SIGNAL(configurationChanged()),
          landmarkController, SLOT(configurationChanged()));
  dialog->exec();
  delete dialog;
}
  ...
  QXmlStreamWriter *xmlWriter)
{
  ...
  xmlWriter->writeTextElement("Mesh",
      mainWindow->actionShowMesh->isChecked() ? "Yes" : "No");
  xmlWriter->writeTextElement("Add",
      mainWindow->actionAddLandmark->isChecked() ? "Yes" : "No");
  xmlWriter->writeTextElement("Delete",
      mainWindow->actionDeleteLandmark->isChecked() ? "Yes" : "No");
  xmlWriter->writeTextElement("Move",
      mainWindow->actionMoveLandmark->isChecked() ? "Yes" : "No");
  xmlWriter->writeTextElement("Landmarks",
      mainWindow->actionShowLandmarks->isChecked() ? "Yes" : "No");
  xmlWriter->writeTextElement("RemoveElement",
      mainWindow->actionRemoveMeshElement->isChecked() ? "Yes" : "No");
  // Refresh state not saved
  ...
  const QDomElement &element)
{
  ...
  while(!child.isNull())
  {
    // Refresh state is not saved
    if(child.toElement().tagName() == "Mesh")
    {
...
saveProject()
{
  ...
  if(!file.open(QFile::WriteOnly | QFile::Text))
  {
    QMessageBox::warning(NULL, tr("Save project"),
	                 tr("Cannot create project file."));
    return;
  }
...
setProjectProperties()
{
  ProjectPropertiesDialog *dialog =
      new ProjectPropertiesDialog(m_projectProperties);
  dialog->exec();
  ...
  const QDomElement &element)
{
  ...
  objectListModel->parseDOM(
      element.firstChildElement(ObjectListModel::xmlTag).toElement());
  m_objectViewerController->parseDOM(
      element.firstChildElement(ObjectViewerController::xmlTag));
  landmarkModel->parseDOM(
      element.firstChildElement(LandmarkModel::xmlTag));
  landmarkModel->parseWarpingDOM(
      element.firstChildElement(LandmarkModel::xmlTagWarping));
  landmarkModel->setMeshData(objectListModel->getMeshObject()); // syncronise
  								// meshes
  ...
  // reads UI state
  {
    ...
    if(!child.isNull())
    {
      mainWindow->restoreState(QByteArray(
	    QByteArray::fromHex(child.text().toAscii())));
    }
  }
  return(true);
}
