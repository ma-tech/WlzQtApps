...
#else
static char _LandmarkDragger_cpp[] = "MRC HGU $Id$";
#endif
#endif
/*!
...
void LandmarkDragger::setType(dragger_mode mode) {
...
void LandmarkDragger::setValid(bool valid) {
  SoBlinker *sw;
...
void LandmarkDragger::setScale(float) {} //not resizeable
