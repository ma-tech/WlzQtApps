...
#else
static char _TranslateRadialDragger_cpp[] = "University of Edinburgh $Id$";
#endif
/*!
...
* 		Toolmaker, chapter 8 (see TranslateRadialDragger.h).
* \ingroup      Controls
*/
...
startCB(
  ...
  SoDragger *dragger)
{
  TranslateRadialDragger *myself = (TranslateRadialDragger *) dragger;
  myself->dragStart();
}
