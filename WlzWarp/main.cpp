...
/*
    //set library search path: these might not work, since
    //could not be tested applciationDirPath() - Zsolth
    QString str=QApplication::applicationDirPath();
    QCoreApplication::addLibraryPath("libs");
    QCoreApplication::addLibraryPath(str+"/lib64");
    QCoreApplication::addLibraryPath(str+"/libs");*/
    {
