...
#else
static char _Contour3DView_cpp[] = "University of Edinburgh $Id$";
#endif
/*!
...
SoIndexedFaceSet * Contour3DView::
Faces3D(
  SoIndexedFaceSet * faces,
  WlzErrorNum& errNum)
{
