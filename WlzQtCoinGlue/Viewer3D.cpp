...
#else
static char _Viewer3D_cpp[] = "University of Edinburgh $Id$";
#endif
/*!
* \file         Viewer3D.cpp
* \author       Zsolt Husz
...
createViewerButtons(
  ...
  SbPList * buttonlist)
{
  SoQtExaminerViewer::createViewerButtons(parent, buttonlist); //avoids
  						// creating X,Y,Z buttons
  ...
  ((QPushButton *)buttonlist->get(5))->setVisible(false);
