...
#else
static char _Points3DView_h[] = "University of Edinburgh $Id$";
#endif
/*!
* \file         Points3DView.h
* \author	Bill Hill
...
* \brief	View for 3D points object
* \ingroup	Views
*/

#ifndef POINTS3DVIEW_H
#define POINTS3DVIEW_H
...
/*!
* \brief	View providing 3D points object visualisation
* \ingroup	Views
*/
class Points3DView: public ObjectView
{
  Q_OBJECT
  public:
    ...
    * \return	  void
    */
    Points3DView (QObject * parent, WoolzObject * object);
  ...
  protected:
    ...
    SoMarkerSet *m_points;		/*!< Shape of the points. */
